...
export function MusicBar({ onToggle }: MusicBarProps) {
  return (
    <motion.div 
      ...
      className="fixed bottom-[112px] md:bottom-8 left-6 right-6 md:left-[calc(16rem+2rem)] md:right-8 h-16 md:h-20 bg-[#0a0a0a]/90 backdrop-blur-3xl border border-white/10 rounded-[24px] px-3 md:px-6 flex items-center justify-between z-40 shadow-[0_8px_32px_rgba(0,0,0,0.4)]"
    >
