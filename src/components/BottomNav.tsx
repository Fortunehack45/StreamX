...
export function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-8 left-6 right-6 z-50">
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[32px] px-3 py-3 flex items-center justify-between shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-x-auto scrollbar-hide">
        {navItems.map((item) => {
