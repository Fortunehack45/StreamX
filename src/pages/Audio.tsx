...
export function Audio() {
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-32 relative overflow-hidden font-sans">
      ...
      <div className="px-4 md:px-12 pt-24 md:pt-28 relative z-10">
      ...
      <div className="fixed bottom-28 md:bottom-6 left-2 right-2 md:left-[280px] md:right-6 h-16 md:h-20 bg-neutral-900/80 backdrop-blur-3xl border border-white/10 rounded-2xl px-3 md:px-6 flex items-center justify-between z-40 shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex flex-col items-center justify-center flex-1 md:w-1/3 ml-auto md:ml-0">
          ...
          <div className="hidden md:flex w-full max-w-md items-center gap-3 mt-1.5">
            ...
            <div className="h-1.5 flex-1 bg-neutral-800 rounded-full overflow-hidden group cursor-pointer relative">
              <div className="h-full bg-white group-hover:bg-indigo-500 w-1/3 relative transition-colors"></div>
            </div>
        ...
        <div className="hidden md:flex w-1/3 justify-end items-center gap-4">
          ...
          <div className="w-24 h-1.5 bg-neutral-800 rounded-full overflow-hidden group cursor-pointer ml-2">
            <div className="h-full bg-white group-hover:bg-indigo-500 w-2/3 transition-colors"></div>
          </div>
        </div>
      </div>
    </div>
